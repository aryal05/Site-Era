    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/services" className="btn-luxury text-white px-6 py-3 rounded-full inline-block">
            Back to Services
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <Link to="/services" className="inline-flex items-center gap-2 text-platinum-300 hover:text-royal-400 transition-colors mb-8">
            <ArrowLeft size={20} />
