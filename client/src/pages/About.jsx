      ...
      <section className="py-24 bg-luxury-50">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <Link to="/contact" className="btn-luxury text-white px-10 py-5 rounded-full font-display font-semibold text-lg transition-all duration-300 inline-flex items-center gap-2 group">
